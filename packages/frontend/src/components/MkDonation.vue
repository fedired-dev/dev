...
<div class="_panel _shadow" :class="$style.root">
	...
	<div :class="$style.main">
		<div :class="$style.title">{{ i18n.ts.didYouLikeFedired }}</div>
		<div :class="$style.text">
			...
			<div style="margin-top: 0.2em;">
				<MkLink target="_blank" url="https://joinfedired.org/docs/for-users/resources/donate/">{{ i18n.ts.learnMore }}</MkLink>
			</div>
		</div>
		<div class="_buttons">
