...
describe('Drive', () => {
	describe('Upload image in a.test and resolve from b.test', () => {
		...
		let image: Fedired.entities.DriveFile, imageInB: Fedired.entities.DriveFile;
		...
		let updatedImage: Fedired.entities.DriveFile, updatedImageInB: Fedired.entities.DriveFile;
		...
		let reupdatedImageInB: Fedired.entities.DriveFile;
	...
	describe('Sensitive flag', () => {
		...
		/** @see https://github.com/fedired-dev/fedired/issues/12208 */
