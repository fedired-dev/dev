	...
	<div :class="[$style.main, $style.panel]">
		...
		<div :class="$style.mainFg">
			...
			<div :class="$style.mainAbout">
				...
				<div v-html="instance.description || i18n.ts.headlineFedired"></div>
			</div>
			...
			<div class="_gaps_s" :class="$style.mainActions">
				...
				<MkButton :class="$style.mainAction" full rounded link to="https://joinfedired.org/servers/">{{ i18n.ts.exploreOtherServers }}</MkButton>
...
const stats = ref<Fedired.entities.StatsResponse | null>(null);

fediredApi('stats', {}).then((res) => {
	stats.value = res;
});
