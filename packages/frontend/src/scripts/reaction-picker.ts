...
class ReactionPicker {
	...
	private targetNote: Ref<Fedired.entities.Note | null> = ref(null);
	...
	public show(src: HTMLElement | null, targetNote: Fedired.entities.Note | null, onChosen?: ReactionPicker['onChosen'], onClosed?: ReactionPicker['onClosed']) {
		this.src.value = src;
