...
const announcement = ref<Fedired.entities.Announcement | null>(null);
const error = ref<any>(null);
const path = computed(() => props.announcementId);

function fetch() {
	announcement.value = null;
	fediredApi('announcements/show', {
...
async function read(target: Fedired.entities.Announcement): Promise<void> {
	...
	target.isRead = true;
	await fediredApi('i/read-announcement', { announcementId: target.id });
	if ($i) {
