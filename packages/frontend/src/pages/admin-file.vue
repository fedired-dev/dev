...
const file = ref<Fedired.entities.DriveFile | null>(null);
const info = ref<Fedired.entities.AdminDriveShowFileResponse | null>(null);
...
async function fetch() {
	file.value = await fediredApi('drive/files/show', { fileId: props.fileId });
	info.value = await fediredApi('admin/drive/show-file', { fileId: props.fileId });
...
async function toggleIsSensitive(v) {
	await fediredApi('drive/files/update', { fileId: props.fileId, isSensitive: v });
	isSensitive.value = v;
}
