...
describe('API visibility', () => {
	describe('Note visibility', () => {
		...
		/** フォロワー */
		let follower: fedired.entities.SignupResponse;
		/** 非フォロワー */
		let other: fedired.entities.SignupResponse;
		/** 非フォロワーでもリプライやメンションをされた人 */
		let target: fedired.entities.SignupResponse;
		/** specified mentionでmentionを飛ばされる人 */
		let target2: fedired.entities.SignupResponse;

		/** public-post */
		let pub: fedired.entities.Note;
		/** home-post */
		let home: fedired.entities.Note;
		/** followers-post */
		let fol: fedired.entities.Note;
		/** specified-post */
		let spe: fedired.entities.Note;

		/** public-reply to target's post */
		let pubR: fedired.entities.Note;
		/** home-reply to target's post */
		let homeR: fedired.entities.Note;
		/** followers-reply to target's post */
		let folR: fedired.entities.Note;
		/** specified-reply to target's post */
		let speR: fedired.entities.Note;

		/** public-mention to target */
		let pubM: fedired.entities.Note;
		/** home-mention to target */
		let homeM: fedired.entities.Note;
		/** followers-mention to target */
		let folM: fedired.entities.Note;
		/** specified-mention to target */
		let speM: fedired.entities.Note;

		/** reply target post */
		let tgt: fedired.entities.Note;
		//#endregion

		const show = async (noteId: fedired.entities.Note['id'], by?: UserToken) => {
