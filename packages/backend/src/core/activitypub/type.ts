...
export interface IObject {
	...
	_fedired_followedMessage?: string | null;
	_fedired_requireSigninToViewContents?: boolean;
	_fedired_makeNotesFollowersOnlyBefore?: number | null;
	_fedired_makeNotesHiddenBefore?: number | null;
	published?: string;
	cc?: ApObject;
	to?: ApObject;
 ...
 * 詳細: https://github.com/fedired-dev/fedired/issues/14239
 */
...
export interface IPost extends IObject {
	...
	_fedired_quote?: string;
	_fedired_content?: string;
	quoteUrl?: string;
}
