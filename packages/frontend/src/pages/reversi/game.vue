...
const game = shallowRef<Fedired.entities.ReversiGameDetailed | null>(null);
const connection = shallowRef<Fedired.ChannelConnection | null>(null);
...
function start(_game: Fedired.entities.ReversiGameDetailed) {
