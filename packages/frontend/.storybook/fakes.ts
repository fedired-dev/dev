...
export function abuseUserReport() {
	return {
		...
		reporter: userDetailed('reporterid', 'reporter', 'joinfedired.org', 'Reporter'),
		targetUser: userDetailed('targetuserid', 'target', 'joinfedired.org', 'Target'),
		assignee: userDetailed('assigneeid', 'assignee', 'joinfedired.org', 'Assignee'),
		me: null,
		forwarded: false,
	};
}
...
export function file(isSensitive = false) {
	return {
		...
		url: 'https://github.com/fedired-dev/fedired/blob/master/packages/frontend/assets/fedi.jpg?raw=true',
		thumbnailUrl: 'https://github.com/fedired-dev/fedired/blob/master/packages/frontend/assets/fedi.jpg?raw=true',
		comment: null,
		folderId: null,
		folder: null,
		userId: null,
...
export function federationInstance(): entities.FederationInstance {
	return {
		...
		maintainerEmail: '',
		isSilenced: false,
		iconUrl: 'https://github.com/fedired-dev/fedired/blob/master/packages/frontend/assets/about-icon.png?raw=true',
		faviconUrl: '',
		themeColor: '',
		infoUpdatedAt: '',
...
export function userLite(id = 'someuserid', username = 'miskist', host: entities.UserDetailed['host'] = 'joinfedired.org', name: entities.UserDetailed['name'] = 'Fedired User'): entities.UserLite {
	return {
		id,
		username,
		host,
...
export function userDetailed(id = 'someuserid', username = 'miskist', host: entities.UserDetailed['host'] = 'joinfedired.org', name: entities.UserDetailed['name'] = 'Fedired User'): entities.UserDetailed {
	return {
		...userLite(id, username, host, name),
		bannerBlurhash: 'eQA^IW^-MH8w9tE8I=S^o{$*R4RikXtSxutRozjEnNR.RQadoyozog',
		bannerUrl: 'https://github.com/fedired-dev/fedired/blob/master/packages/frontend/assets/fedi.jpg?raw=true',
		birthday: '2014-06-20',
		createdAt: '2016-12-28T22:49:51.000Z',
