...
const props = withDefaults(defineProps<{
	folder: Fedired.entities.DriveFolder;
	isSelected?: boolean;
	selectMode?: boolean;
}>(), {
	isSelected: false,
...
const emit = defineEmits<{
	(ev: 'chosen', v: Fedired.entities.DriveFolder): void;
	(ev: 'unchose', v: Fedired.entities.DriveFolder): void;
	(ev: 'move', v: Fedired.entities.DriveFolder): void;
	(ev: 'upload', file: File, folder: Fedired.entities.DriveFolder);
	(ev: 'removeFile', v: Fedired.entities.DriveFile['id']): void;
	(ev: 'removeFolder', v: Fedired.entities.DriveFolder['id']): void;
	(ev: 'dragstart'): void;
	(ev: 'dragend'): void;
}>();
