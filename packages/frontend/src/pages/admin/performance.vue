	...
	<MkSpacer :contentMax="700" :marginMin="16" :marginMax="32">
		<div class="_gaps">
			...
			<MkFolder :defaultOpen="true">
				...
				<template #label>Fedired® Fan-out Timeline Technology™ (FTT)</template>
				...
				<div class="_gaps">
					<MkSwitch v-model="fttForm.state.enableFanoutTimeline">
						...
						<template #caption>
							...
							<div><MkLink target="_blank" url="https://joinfedired.org/docs/for-admin/features/ftt/">{{ i18n.ts.details }}</MkLink></div>
						</template>
					</MkSwitch>
			...
			<MkFolder :defaultOpen="true">
				<template #icon><i class="ti ti-bolt"></i></template>
				<template #label>Fedired® Reactions Boost Technology™ (RBT)<span class="_beta">{{ i18n.ts.beta }}</span></template>
...
const meta = await fediredApi('admin/meta');
