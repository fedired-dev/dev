...
const props = withDefaults(defineProps<{
	currentVisibility: typeof Fedired.noteVisibilities[number];
	isSilenced: boolean;
	localOnly: boolean;
	src?: HTMLElement;
...
const emit = defineEmits<{
	(ev: 'changeVisibility', v: typeof Fedired.noteVisibilities[number]): void;
	(ev: 'closed'): void;
}>();

const v = ref(props.currentVisibility);

function choose(visibility: typeof Fedired.noteVisibilities[number]): void {
	v.value = visibility;
