...
const channel = ref<Fedired.entities.Channel | null>(null);
...
const pinnedNotes = ref<{ id: Fedired.entities.Note['id'] }[]>([]);

watch(() => bannerId.value, async () => {
	if (bannerId.value == null) {
		bannerUrl.value = null;
	} else {
		bannerUrl.value = (await fediredApi('drive/files/show', {
...
async function fetchChannel() {
	...
	channel.value = await fediredApi('channels/show', {
