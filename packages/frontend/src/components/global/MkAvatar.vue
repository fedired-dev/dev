...
const props = withDefaults(defineProps<{
	...
	preview?: boolean;
	indicator?: boolean;
	decorations?: (Omit<Fedired.entities.UserDetailed['avatarDecorations'][number], 'id'> & { blink?: boolean; })[];
...
function getDecorationUrl(decoration: Omit<Fedired.entities.UserDetailed['avatarDecorations'][number], 'id'>) {
...
function getDecorationAngle(decoration: Omit<Fedired.entities.UserDetailed['avatarDecorations'][number], 'id'>) {
	const angle = decoration.angle ?? 0;
	return angle === 0 ? undefined : `${angle * 360}deg`;
}

function getDecorationScale(decoration: Omit<Fedired.entities.UserDetailed['avatarDecorations'][number], 'id'>) {
	const scaleX = decoration.flipH ? -1 : 1;
	return scaleX === 1 ? undefined : `${scaleX} 1`;
}

function getDecorationOffset(decoration: Omit<Fedired.entities.UserDetailed['avatarDecorations'][number], 'id'>) {
