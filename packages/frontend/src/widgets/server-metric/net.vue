...
const props = defineProps<{
	connection: Fedired.ChannelConnection<Fedired.Channels['serverStats']>,
	meta: Fedired.entities.ServerInfoResponse
}>();

const viewBoxX = ref<number>(50);
const viewBoxY = ref<number>(30);
const stats = ref<Fedired.entities.ServerStats[]>([]);
...
function onStats(connStats: Fedired.entities.ServerStats) {
...
function onStatsLog(statsLog: Fedired.entities.ServerStatsLog) {
