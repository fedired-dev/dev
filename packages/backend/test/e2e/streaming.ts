...
describe('Streaming', () => {
	...
	describe('Streaming', () => {
		// Local users
		let ayano: fedired.entities.SignupResponse;
		let kyoko: fedired.entities.SignupResponse;
		let chitose: fedired.entities.SignupResponse;
		let kanako: fedired.entities.SignupResponse;
		let erin: fedired.entities.SignupResponse;

		// Remote users
		let akari: fedired.entities.SignupResponse;
		let chinatsu: fedired.entities.SignupResponse;
		let takumi: fedired.entities.SignupResponse;

		let kyokoNote: fedired.entities.Note;
		let kanakoNote: fedired.entities.Note;
		let takumiNote: fedired.entities.Note;
		let list: any;
		...
		describe('Home Timeline', () => {
			...
			/**
			 * TODO: 落ちる
			 * @see https://github.com/fedired-dev/fedired/issues/13474
