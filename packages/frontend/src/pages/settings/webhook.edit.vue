...
const webhook = await fediredApi('i/webhooks/show', {
...
function save() {
	const events: Fedired.entities.UserWebhook['on'] = [];
...
async function test(type: Fedired.entities.UserWebhook['on'][number]): Promise<void> {
