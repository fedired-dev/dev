...
describe('アンテナ', () => {
	...
	type Antenna = fedired.entities.Antenna;
	type User = fedired.entities.SignupResponse;
	type Note = fedired.entities.Note;
	...
	let alicePost: Note;
	let aliceList: fedired.entities.UserList;
	let bobFile: fedired.entities.DriveFile;
	let bobList: fedired.entities.UserList;
	...
	describe('のノート', () => {
		...
		test.each([
			...
			{
				// https://github.com/fedired-dev/fedired/issues/9025
		...
		// BUG 7日過ぎると作り直すしかない。 https://github.com/fedired-dev/fedired/issues/10476
