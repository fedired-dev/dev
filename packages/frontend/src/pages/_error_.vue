...
<Transition :name="defaultStore.state.animation ? '_transition_zoom' : ''" appear>
	<div v-show="loaded" :class="$style.root">
		...
		<div class="_gaps">
			...
			<div><MkLink url="https://joinfedired.org/docs/for-users/resources/troubleshooting/" target="_blank">{{ i18n.ts.troubleshooting }}</MkLink></div>
...
const meta = ref<Fedired.entities.MetaResponse | null>(null);
