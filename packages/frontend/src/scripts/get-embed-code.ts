...
export function getEmbedCode(path: string, params?: EmbedParams): string {
	...
	const iframeCode = [
		`<iframe src="${url + path + paramString}" data-fedired-embed-id="${iframeId}" loading="lazy" referrerpolicy="strict-origin-when-cross-origin" style="border: none; width: 100%; max-width: 500px; height: 300px; color-scheme: light dark;"></iframe>`,
