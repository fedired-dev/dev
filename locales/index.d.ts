...
export interface Locale extends ILocale {
     ...
     * ノートでつながるネットワーク
     */
    "headlineFedired": string;
    /**
     * ようこそ！Fediredは、オープンソースの分散型マイクロブログサービスです。
    ...
    "introFedired": string;
    /**
     * {name}は、オープンソースのプラットフォーム<b>Fedired</b>のサーバーのひとつです。
     */
    "poweredByFediredDescription": ParameterizedString<"name">;
    /**
     * {month}月 {day}日
     */
    ...
    /**
     * Fediredを自分でインストールした場合は、設定ファイルに入力したパスワードを使用してください。
     * Fediredのホスティングサービスなどを使用している場合は、提供されたパスワードを使用してください。
    ...
    "flagAsBot": string;
    /**
     * このアカウントがプログラムによって運用される場合は、このフラグをオンにします。オンにすると、反応の連鎖を防ぐためのフラグとして他の開発者に役立ったり、Fediredのシステム上での扱いがBotに合ったものになります。
     */
    ...
    /**
     * Fedired Hubからサーバーを選択
     */
    "chooseServerOnFediredHub": string;
    /**
     * サーバーのドメインを直接指定
     */
    ...
    /**
     * Fediredのインストールが完了しました！管理者アカウントを作成しましょう。
     */
    "intro": string;
    /**
     * 完了
    ...
    "scratchpad": string;
    /**
     * スクラッチパッドは、AiScriptの実験環境を提供します。Fediredと対話するコードの記述、実行、結果の確認ができます。
     */
    ...
    "private": string;
    /**
     * Fediredは有志によって様々な言語に翻訳されています。{link}で翻訳に協力できます。
     */
    ...
    /**
     * オンにすると、問題が発生したときにエラーの詳細情報がFediredに共有され、ソフトウェアの品質向上に役立てることができます。エラー情報には、OSのバージョン、ブラウザの種類、行動履歴などが含まれます。
     */
    ...
    /**
     * Fediredを気に入っていただけましたか？
     */
    "didYouLikeFedired": string;
    /**
     * Fediredは{host}が使用している無料のソフトウェアです。これからも開発を続けられるように、ぜひ寄付をお願いします！
     */
    ...
    /**
     * ソースコードが公開されているリポジトリがある場合、そのURLを記入します。Fediredを現状のまま（ソースコードにいかなる変更も加えずに）使用している場合は https://github.com/fedired-dev/fedired と記入します。
     */
    ...
    "_initialAccountSetting": {
        ...
        /**
         * このまま{name}(Fedired)の使い方についてのチュートリアルに進むこともできますが、ここで中断してすぐに使い始めることもできます。
         */
    ...
    "_initialTutorial": {
        ...
        "_landing": {
            ...
            "title": string;
            /**
             * ここでは、Fediredの基本的な使い方や機能を確認できます。
             */
            "description": string;
        };
        "_note": {
            ...
            "title": string;
            /**
             * Fediredでの投稿は「ノート」と呼びます。ノートはタイムラインに時系列で並んでいて、リアルタイムで更新されていきます。
             */
            "description": string;
            /**
        ...
        "_timeline": {
            ...
            "title": string;
            /**
             * Fediredには、使い方に応じて複数のタイムラインが用意されています（サーバーによってはいずれかが無効になっていることがあります）。
             */
            "description1": string;
            /**
        ...
        "_postNote": {
            ...
            "title": string;
            /**
             * Fediredにノートを投稿する際には、様々なオプションの設定が可能です。投稿フォームはこのようになっています。
             */
            "description1": string;
            "_visibility": {
                /**
        ...
        "_done": {
            ...
            "title": string;
            /**
             * ここで紹介した機能はほんの一部にすぎません。Fediredの使い方をより詳しく知るには、{link}をご覧ください。
             */
    ...
    "_accountMigration": {
         ...
         *
         * （この説明はこのサーバー（Fedired v13.12.0以降）の仕様です。Mastodonなどの他のActivityPubソフトウェアでは挙動が異なる場合があります。）
         */
    ...
    "_achievements": {
        ...
        "_types": {
            ...
            "_iLoveFedired": {
                ...
                "description": string;
                /**
                 * Fediredを使ってくださりありがとうございます！ by 開発チーム
                 */
                "flavor": string;
            };
            "_foundTreasure": {
    ...
    "_aboutFedired": {
        /**
         * Fediredはsyuiloによって2014年から開発されている、オープンソースのソフトウェアです。
         */
        "about": string;
        /**
         * コントリビューター
        ...
        "original": string;
        /**
         * {name}はオリジナルのFediredを改変したバージョンを使用しています。
         */
    ...
    "_soundSettings": {
        ...
        /**
         * 長い音声を使用するとFediredの使用に支障をきたす可能性があります。それでも続行しますか？
         */
    ...
    "_urlPreviewSetting": {
        ...
        "summaryProxy": string;
        /**
         * Fedired本体ではなく、サマリープロキシを使用してプレビューを生成します。
         */
