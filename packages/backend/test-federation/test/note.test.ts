...
describe('Note', () => {
	...
	describe('Note content', () => {
		test('Consistency of Public Note', async () => {
			...
			deepStrictEqualWithExcludedFields(note, resolvedNote, [
				...
				'fileIds',
				'files',
				/** @see https://github.com/fedired-dev/fedired/issues/12409 */
				'reactionAcceptance',
				'userId',
				'user',
				'uri',
		...
		test('localOnly', async () => {
			...
			rejects(
				...
				(err: any) => {
					 ...
					 * @see https://github.com/fedired-dev/fedired/issues/12736
					 */
	...
	describe('Deletion', () => {
		...
		describe('Deletion of remote user\'s note for moderation', () => {
			let note: Fedired.entities.Note;
			 ...
			 *        @see https://github.com/fedired-dev/fedired/issues/11437
			 */
