...
type AdminAnnouncementType = Fedired.entities.AdminAnnouncementsCreateRequest & { id: string; }
...
async function done() {
	...
	} satisfies Fedired.entities.AdminAnnouncementsCreateRequest;
...
async function del() {
	...
	if (props.announcement) {
		await fediredApi('admin/announcements/delete', {
			id: props.announcement.id,
		});
	}
