...
interface UserAction {
	title: string,
	handler: (user: Fedired.entities.UserDetailed) => void;
}

interface NoteAction {
	title: string,
	handler: (note: Fedired.entities.Note) => void;
}

interface NoteViewInterruptor {
	handler: (note: Fedired.entities.Note) => unknown;
}
...
interface PageViewInterruptor {
	handler: (page: Fedired.entities.Page) => unknown;
}
...
export const defaultStore = markRaw(new Storage('base', {
	...
	defaultNoteVisibility: {
		where: 'account',
		default: 'public' as (typeof Fedired.noteVisibilities)[number],
	},
	...
	tl: {
		...
		default: {
			...
			userList: null as Fedired.entities.UserList | null,
			filter: {
				withReplies: true,
				withRenotes: true,
				withSensitive: true,
	...
	pinnedUserLists: {
		where: 'deviceAccount',
		default: [] as Fedired.entities.UserList[],
	},
