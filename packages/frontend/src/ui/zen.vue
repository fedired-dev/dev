...
<!--
	...
	See https://github.com/fedired-dev/fedired/issues/10905
-->
<div v-if="showBottom" :class="$style.bottom">
	<button v-tooltip="i18n.ts.goToFedired" :class="['_button', '_shadow', $style.button]" @click="goToFedired"><i class="ti ti-home"></i></button>
</div>
</template>
