...
import { pendingApiRequestsCount } from '@/scripts/fedired-api.js';
...
const notifications = ref<Fedired.entities.Notification[]>([]);

function onNotification(notification: Fedired.entities.Notification, isClient = false) {
	...
	sound.playFediredSfx('notification');
}
